...
const FoundItems: React.FC = () => {
  ...
  useEffect(() => {
    applyFiltersAndSort();
  }, [searchQuery, filterCategory, sortBy, sortOrder, foundItems]);
      ...
      <Box sx={{ minHeight: '100vh', bgcolor: 'grey.50', display: 'flex', alignItems: 'center' }}>
        <Container maxWidth="sm">
          <Paper sx={{ p: 4, textAlign: 'center', borderRadius: 3 }}>
            ...
            <Button variant="contained" onClick={fetchFoundItems} startIcon={<RefreshIcon />}>
              Try Again
            </Button>
          </Paper>
        </Container>
    ...
    <Box sx={{ minHeight: '100vh', bgcolor: 'grey.50' }}>
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 2, md: 4 }, px: { xs: 1, sm: 2, md: 0 } }}>
              ...
              <Grid item xs={12} md={2}>
                <FormControl fullWidth>
                  ...
                  >
                    ...
                    <MenuItem value="Claimed">Claimed Items</MenuItem>
        ...
        {filteredItems.length === 0 ? (
          ...
          >
            <Box sx={{ mb: 3 }}>
              <FoundInPageIcon sx={{ fontSize: 64, color: 'grey.400' }} />
            </Box>
                    ...
                    <CardContent sx={{ flexGrow: 1, p: 3 }}>
                      ...
                      <Button
                        ...
                        sx={{
                          ...
                          background: 'linear-gradient(135deg, #2e7d32 0%, #1b5e20 100%)',
                          '&:hover': {
                            background: 'linear-gradient(135deg, #1b5e20 0%, #0d4a0f 100%)',
